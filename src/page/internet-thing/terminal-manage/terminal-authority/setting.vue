		...
		<el-row class="g-header">
		  <el-col :span="8">
		  	<el-breadcrumb separator-class="el-icon-arrow-right" class="g-top-left">
				  <el-breadcrumb-item :to="{path: '/terminal-authority/list'}">终端权限</el-breadcrumb-item>
				  <el-breadcrumb-item>设置</el-breadcrumb-item>
				</el-breadcrumb>
		  </el-col>
		  <el-col :span="16" class="tr">
  	    <el-button type="info" class="g-top-btn" size="mini" @click="$router.push('/terminal-authority/list')">
  	      返回
  	    </el-button>
		  </el-col>
		</el-row>
...
export default {
	...
	mounted () {
		let self = this
		self.allData = getToken('SET_TERMINAL_AUTHORITY_LIST', 'json')
    ...
    async getAppsReq () {
    	...
    	let GetAppsReqData = {  //获取应用列表
    		"commandId": 0x0503,
    		"reqNode": "WEB",
    		"body": {"pageSize": self.paginationObj.pageSize, "pageIndex": self.paginationObj.currentPage, type: 0}
    	}
    ...
    async UpdateDeviceAppsReq () {
    	...
    	let UpdateDeviceAppsReqData = {
    		"commandId": 0x0529,
    		"reqNode": "WEB",
    		"body": {"sn": self.merData.sn, merId: self.merData.merId, appList: self.appList}
    	}
    	...
    	if (resData.data.retCode !== 0) {
  		...
  		setToken('SET_TERMINAL_AUTHORITY_LIST', self.multipleSelection)
    }
	},
	filters: {
